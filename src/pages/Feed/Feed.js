...
class Feed extends Component {
  ...
  componentDidMount() {
    ...
    fetch(`https://fakebook-demo-rest-api.herokuapp.com/graphql`, {
      method: "POST",
      headers: {
  ...
  finishEditHandler = (postData) => {
    ...
    fetch("https://fakebook-demo-rest-api.herokuapp.com/post-image", {
      method: "PUT",
      headers: {
        Authorization: `Bearer ${this.props.token}`,
      },
      ...
      .then((fileResData) => {
        ...
        return fetch("https://fakebook-demo-rest-api.herokuapp.com/graphql", {
          method: "POST",
          body: JSON.stringify(graphqlQuery),
          headers: {
            Authorization: `Bearer ${this.props.token}`,
